...
public class CsvExportProvider {
    ...
    public void generate(
        ...
        properties.put("id", position -> position.getId());
        properties.put("deviceId", position -> position.getDeviceId());
        properties.put("protocol", position -> position.getProtocol());
        ...
        properties.put("valid", position -> position.getValid());
        properties.put("latitude", position -> position.getLatitude());
        properties.put("longitude", position -> position.getLongitude());
        properties.put("altitude", position -> position.getAltitude());
        properties.put("speed", position -> position.getSpeed());
        properties.put("course", position -> position.getCourse());
        properties.put("address", position -> position.getAddress());
        properties.put("accuracy", position -> position.getAccuracy());
