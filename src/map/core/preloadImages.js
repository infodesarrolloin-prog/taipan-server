...
import pauseSvg from '../../resources/images/icon/pause.svg';
import arrowSvg from '../../resources/images/icon/arrow.svg';
import powerSvg from '../../resources/images/icon/power.svg';
...
export const getDeviceStatusInfo = (device, position) => {
  ...
  const isMoving = position && (speed >= 0.1 || position.attributes.motion === true);
  if (isMoving) {
    return {
      category: 'arrow',
      color: 'success',
