...
public class PositionResource extends BaseResource {
    ...
    public Stream<Position> getJson(
        ...
        if (!positionIds.isEmpty()) {
            ...
            if (from != null && to != null) {
                permissionsService.checkRestriction(getUserId(), userRestrictions -> userRestrictions.getDisableReports());
    ...
    public Response removeById(@PathParam("id") long positionId) throws StorageException {
        permissionsService.checkRestriction(getUserId(), userRestrictions -> userRestrictions.getReadonly());
